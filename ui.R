shinyUI(fluidPage(
  ...
  sidebarPanel(
    conditionalPanel(condition = "input.tabselected ==3",
                     ...
                     br(),
                     radioButtons("color", "2. Select the color", choices = c("Green", "Red", "Yellow", "Grey"), selected = "Grey"),
    ),
  ...
  mainPanel(
    tabsetPanel(
      tabPanel(
        ...
        conditionalPanel(condition = "output.graph_or_text == 'graph'", plotOutput("hist2"))
      ),
